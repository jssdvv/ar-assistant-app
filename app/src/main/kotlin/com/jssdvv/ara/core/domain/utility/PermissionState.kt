 ...
 *
 * @property [Granted] When the permission has been granted and the user can use the feature.
 * @property [Denied] When the permission is denied, but the user can be shown a rationale to
 * the permission again.
 * @property [PermanentlyDenied] When the permission is denied and the user has also checked the
 * "Don't ask again" checkbox or option, or the user has denied the second request for the
 * permission, so the permission dialog should not be shown again.
 */
sealed interface PermissionState {

    /**
     * Represents the state where the permission has been granted and the user can use the feature.
     *
    ...
    /**
     * Represents the state where the permission is denied, but the user can be shown a rationale to
     * the permission again.
     *
     * This state is triggered when the [ContextCompat.checkSelfPermission] class is evaluated and
    ...
    /**
     * Represents the state where the permission is denied and the permission dialog should not be
     * shown again.
     *
     * This state is triggered when the package has been flagged by **USER_SET** and the user
     * denied the second request for the permission or when the user has checked the "Don't ask
