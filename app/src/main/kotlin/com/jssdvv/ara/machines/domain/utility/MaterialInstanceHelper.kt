...
val GIZMO_X_COLOR = floatArrayOf(0.90F, 0.20F, 0.30F)
val GIZMO_Y_COLOR = floatArrayOf(0.50F, 0.80F, 0.10F)
val GIZMO_Z_COLOR = floatArrayOf(0.20F, 0.50F, 0.90F)
 ...
 */
fun MaterialLoader.createModelColorMaterialInstance(color: FloatArray = DISABLED_COLOR) =
